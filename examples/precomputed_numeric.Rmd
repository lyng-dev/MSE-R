...
up1<-DT[up1]
up1<-up1[order(Market,UpStream,UpStream2,DownStream)]
...
up2<-DT[up2]
up2<-up2[order(Market,UpStream1,UpStream,DownStream)]
...
up3<-DT[up3]
up3<-up3[order(Market,UpStream,UpStream2,DownStream)]
...
up4<-DT[up4]
up4<-up4[order(Market,UpStream1,UpStream,DownStream)]
